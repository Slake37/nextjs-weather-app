    ...
    <div className="flex flex-col justify-center items-center mt-5  py-5">
      ...
      <div className="flex justify-between items-center w-full mt-5">
        {threeDaysForecast.forecast.forecastday.map((data) => (
          <div className='flex flex-col justify-center items-center mx-4 border-2 rounded-md drop-shadow-2xl p-1'>
            <p>{data.date}</p>
            ...
            <div className='flex justify-center items-center text-center'>
              ...
              <p>-</p>
              <p className='flex justify-center items-center text-center text-sm'><BsThermometerHigh/>{data.day.maxtemp_c}<RiCelsiusLine/></p>
            </div>
            <div className='flex justify-center items-center mt-3'>
              <p className='flex flex-col justify-center items-center text-center text-sm'><BsFillSunriseFill className='text-2xl'/>{data.astro.sunrise}</p>
              <p className='mx-1'>-</p>
              <p className='flex flex-col justify-center items-center text-center text-sm'><BsFillSunsetFill className='text-2xl'/>{data.astro.sunset}</p>
            </div>
          </div>
        ))}
      </div>
